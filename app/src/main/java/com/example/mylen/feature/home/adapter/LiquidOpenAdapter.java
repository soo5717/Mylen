...
public class LiquidOpenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView tv_brand, tv_name, tv_d_day;
    ...
    public LiquidOpenAdapter(Context mContext, ArrayList<LiquidResponse.LiquidInfo> liquidInfos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_activity_main_liquid_open, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ViewHolder viewHolder = (LiquidOpenAdapter.ViewHolder) holder;
        viewHolder.tv_brand.setText(liquidInfos.get(position).getBrand());
        viewHolder.tv_name.setText(liquidInfos.get(position).getName());
        viewHolder.tv_d_day.setText(getDDay(liquidInfos.get(position).getOpenDate()));
    }
